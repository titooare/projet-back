...
else
{
    if ($isPasswordCorrect) {
        ...
        $_SESSION['pseudo'] = $pseudo;
				...
				$_SESSION['btnVendre']= '<a href="formInsJeux.php"title="contact"><button class="btn btn-outline-warning my-2 my-sm-0 ml-4 border-dark" type="submit">Vendre</button></a>';
