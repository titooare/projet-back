...
$reponse = $bdd->query('SELECT * FROM jeux_video ORDER BY ID DESC LIMIT 0, 18');
                  ...
                  <div class="card col-4 p-4 mb-4 ">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text"><?php echo $donnees['commentaires']; ?></p>
                        ...
                        <button type="button" class="btn btn-danger "><a title="Titre du lien" href="pgDoom.php?id=<?php echo $donnees['ID'] ?>">acheter</a></button>
...
<nav aria-label="... p-3">
  <ul class="pagination">
    <li class="page-item ">
      <a class="page-link disabled" href="index.php" tabindex="-1">Retour</a>
    </li>
    <li class="page-item "><a class="page-link" href="index.php">1</a></li>
    <li class="page-item ">
      <a class="page-link" href="index2.php">2 <span class="sr-only">(current)</span></a>
    </li>
